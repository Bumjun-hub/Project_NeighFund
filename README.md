...
- 🧑‍🤝‍🧑 **소모임 기능**
- 지역 주민 기반 소모임 개설 및 참여
- 모임 소개, 일정, 정원 설정
- 참여 / 취소 관리
- 이미지 업로드 및 게시글 CRUD

- 🎨 원데이 클래스 기능
- 지역 소상공인 및 개인 강사 클래스 개설
- 일정 / 장소 / 가격 / 모집 인원 설정
- 클래스 신청 및 취소
- 이미지 첨부 및 상세 소개
...
- 지역 주민이 관심사를 기반으로 소모임을 개설하고 참여할 수 있는 커뮤니티 기능입니다.
- 단순 게시판이 아닌 **지속적인 만남과 관계 형성**을 목표로 설계하였습니다.

![소모임 목록](./screenshots/group.png)
> 소모임 목록 화면 - 모임 제목, 지역, 모집 인원, 참여 현황 확인 가능

![소모임 상세](./screenshots/groupdetail.png)

![](./screenshots/groupdetail2.png)
> 소모임 상세 화면 - 모임 소개, 일정, 참여 여부 및 상세 정보 확인

![소모임 작성](./screenshots/groupcreate.png)
![](./screenshots/groupcreate2.png)
> 소모임 개설 화면 - 제목, 내용, 일정, 정원 설정 및 이미지 업로드 가능

---

### 🎨 원데이 클래스 기능

- 지역 소상공인 및 개인 강사가 클래스를 개설하고 주민이 신청할 수 있는 기능입니다.
- 오프라인 활동을 플랫폼과 연결하여 **지역 경제 활성화**를 목표로 합니다.

![원데이 클래스 목록](./screenshots/class.png)
